      ...
      <Dialog open={openVotedDialog} disableEscapeKeyDown disableBackdropClick>
        ...
        <DialogContent>
          <DialogContentText style={{ fontSize: '1.2rem', textAlign: 'center' }}>
            Your movie selection has been successfully submitted. Waiting for everyone else to finish voting...
          </DialogContentText>
        </DialogContent>
      </Dialog>
      <Dialog open={openTiebreakerDialog} onClose={closeTiebreakerDialog} disableEscapeKeyDown disableBackdropClick>
        <DialogTitle style={{ textAlign: 'center' }}>
          <h2>Tiebreaker!</h2>
        </DialogTitle>
        <DialogContent>
          <DialogContentText style={{ fontSize: '1.2rem', textAlign: 'center' }}>
            The last vote resulted in a tie between {movieList && movieList.movies.length} movies. A new vote has been
            initiated to resolve the tie. Please select {voteLimit} of these movies to watch.
          </DialogContentText>
        </DialogContent>
        <DialogActions style={{ justifyContent: 'center' }}>
          <Button onClick={closeTiebreakerDialog} color="secondary" variant="contained" size="large" autoFocus>
            Continue
          </Button>
        </DialogActions>
      </Dialog>
